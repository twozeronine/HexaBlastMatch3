...
public class StageManager
{
    ...
    private static Dictionary<Vector2Int, Tile> DeserializedStageMap(int stageId)
    {
        ...
        var deSerializedStageTile = new Dictionary<Vector2Int,Tile>()
        {
            ...
            {new Vector2Int(2,4),new Tile(){IsValid = true,Type = TileType.Normal,TilePos = new Vector2Int(2,4)}},
            ...
            {new Vector2Int(2,12),new Tile(){IsValid = false,Type = TileType.Empty,TilePos = new Vector2Int(2,12)}},
            ...
            {new Vector2Int(4,2),new Tile(){IsValid = true,Type = TileType.Normal,TilePos = new Vector2Int(4,2)}},
            ...
            {new Vector2Int(4,14),new Tile(){IsValid = false,Type = TileType.Empty,TilePos = new Vector2Int(4,14)}},
            ...
            {new Vector2Int(6,4),new Tile(){IsValid = true,Type = TileType.Normal,TilePos = new Vector2Int(6,4)}},
            ...
            {new Vector2Int(6,12),new Tile(){IsValid = false,Type = TileType.Empty,TilePos = new Vector2Int(6,12)}},
